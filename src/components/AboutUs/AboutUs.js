...
import { CardContainer, TitleAboutUs, Introduction, BridgetWrapper, BridgetInformation, FionaWrapper, FionaInformation, LinksWrapper, Icon, CoffeeIcon, CoffeeIconContainer, ImgContainerBridget, ImgContainerFiona, Img } from './AboutUs.styles'
